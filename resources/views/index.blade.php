...
<body class="font-serif">
    ...
    <section class="fixed top-0 left-0 right-0 bg-white shadow-md z-50">
        <nav class="flex justify-around py-4">
            <ul class="flex space-x-8 text-lg">
                ...
                <li><a href="Library/earn" class="hover:text-red-500">Library/earn</a></li>
    ...
    <!-- About  -->
    <section id="About" class="min-h-screen flex flex-col justify-center py-16">
        <div class="flex flex-wrap items-center justify-around">
            <div class="w-1/2 flex justify-center">
                <img src="assets/image/image.png" class="w-96" alt="About Image">
            </div>
            <div class="w-1/2 text-center space-y-4">
                <h1 class="text-4xl font-bold text-red-600"><span class="text-gray-800">Meet</span> Library/Learn</h1>
                <p class="text-lg leading-relaxed text-gray-700">
                    “Books open doors to endless adventures and knowledge. At LibraryLearn, every page is a chance to explore, learn, and grow. Let’s dive into the joy of reading together!”
                </p>
            </div>
        </div>
    </section>
    ...
    <section id="Contact" class="py-16 bg-white text-center">
        ...
        <div class="bg-red-100 shadow-md rounded-lg max-w-md mx-auto p-6">
            <form class="space-y-4">
                <input type="text" placeholder="Nama" class="w-full border border-gray-300 rounded-lg p-3 focus:ring focus:ring-red-300">
                <input type="text" placeholder="Email" class="w-full border border-gray-300 rounded-lg p-3 focus:ring focus:ring-red-300">
                <input type="text" placeholder="Catatan" class="w-full border border-gray-300 rounded-lg p-3 focus:ring focus:ring-red-300">
                <button type="submit" class="bg-red-500 text-white rounded-lg px-6 py-3 hover:bg-red-600 transition">Submit</button>
            </form>
        </div>
    </section>
    ...
    <footer class="bg-red-500 text-white py-8">
        <div class="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-6 text-center">
            <div>
                ...
                <p>+6295756789</p>
                <p>@Library Learn</p>
                <p>Library/Learn@gmail.com</p>
            </div>
            <div>
                <h2 class="text-xl font-semibold">Our Service</h2>
                <p>Recommendation</p>
                <p>New Book</p>
                <p>BestSeller Book</p>
            </div>
